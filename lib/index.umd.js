(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.RevolutionScreenPlayer = factory());
  ...
  class YTSCompiler {
    ...
    compile(schema) {
      ...
      if (schema_description.oneOf) {
        const oneOf = this.parse_oneOf_field(schema_description.oneOf);
        console.log("OKOK", oneOf);
        mergeObjects(swagger_schema, {
          oneOf
        });
      }
